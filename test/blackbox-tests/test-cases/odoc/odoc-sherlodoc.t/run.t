...
This test if `.odocl` files are generated
  ...
  /* Sherlodoc DB for: */
  /*   - ../../_odocl/bar/page-index.odocl */
  /*   - --favored ../../_odocl/bar/bar/bar.odocl */
  /*   - --favored ../../_odocl/bar/bar/page-index.odocl */
  $ cat ./_build/default/_doc/_html/foo/db.js
  /* Sherlodoc DB for: */
  /*   - ../../_odocl/foo/page-index.odocl */
  /*   - --favored ../../_odocl/foo/foo.byte/foo_byte.odocl */
  /*   - --favored ../../_odocl/foo/foo/foo.odocl */
  /*   - --favored ../../_odocl/foo/foo/foo2.odocl */
  /*   - --favored ../../_odocl/foo/foo/foo3.odocl */
  /*   - --favored ../../_odocl/foo/foo.byte/page-index.odocl */
  /*   - --favored ../../_odocl/foo/foo/page-index.odocl */
