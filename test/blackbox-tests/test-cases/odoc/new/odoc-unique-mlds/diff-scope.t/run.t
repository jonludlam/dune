Duplicate mld's in different scope
  $ dune build @doc-new --display short 2>&1 | grep page
          ...
          odoc _doc_new/index/external/ocaml/page-ocaml.odoc
          odoc _doc_new/odoc/pkg/scope2/page-foo.odoc
          odoc _doc_new/odoc/pkg/scope1/page-foo.odoc
          odoc _doc_new/index/page-docs.odocl
          odoc _doc_new/odoc/pkg/scope1/page-foo.odocl
          odoc _doc_new/index/local/scope1/page-scope1.odocl
          odoc _doc_new/odoc/pkg/scope2/page-foo.odocl
          odoc _doc_new/index/local/scope2/page-scope2.odocl
          odoc _doc_new/index/external/ocaml/page-ocaml.odocl
