This test generates documentation for non-hidden modules only for a library:
 ...
 Hidden modules should not be linked
  ...
  _build/default/_doc/_odocl/foo/foo/impl-foo.odocl
  _build/default/_doc/_odocl/foo/foo/impl-foo__.odocl
  _build/default/_doc/_odocl/foo/foo/impl-foo__Bar.odocl
 ...
 We don't expect html for hidden modules
  ...
  _build/default/_doc/_html/foo/foo/bar.ml.html
  _build/default/_doc/_html/foo/foo/foo.ml.html
  _build/default/_doc/_html/foo/foo/foo__.ml-gen.html
